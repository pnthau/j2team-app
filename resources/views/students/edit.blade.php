                    ...
                    <form method="POST" action="{{ route('students.update', ['student' => $viewData['student']->id]) }}"
                                ...
                                <div class="col-sm-10">
                                    <select name="status" class="selectpicker" data-title="Select status"
                                        ...
                                        @foreach ($studentsStatus as $option => $value)
                                            <option value="{{ $value }}"
                                                {{ $value === $getStatusByKey($viewData['student']->status) ? 'selected' : '' }}>
                                                {{ $option }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="gender" class="selectpicker" data-title="Select Gender"
                                        data-style="btn-default btn-block" data-menu-style="dropdown-blue">
                                        <option value="male"
                                            {{ $viewData['student']->gender === 'Male' ? 'selected' : '' }}>
                                            Male</option>
                                        <option value="female"
                                            {{ $viewData['student']->gender === 'Female' ? 'selected' : '' }}>
                                            Female</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <img src="{{ asset('storage/imgs/' . $viewData['student']->avatar) }}" alt="avatar">
